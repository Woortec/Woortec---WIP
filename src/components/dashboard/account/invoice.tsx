...
export function InvoiceHistory(): React.JSX.Element {
              ...
              <Stack spacing={2} sx={{ mt: 2, mb: 2 }}>
                {invoices.map((invoice) => (
                  <Stack
                    ...
                    alignItems="center"
                    sx={{'@media (max-width:770px)': {display:'flex', flexDirection:'column',
                      textAlign:'left',
                      }}}
                  >
                    <Stack sx={{'@media (max-width:770px)':{display:'flex', flexDirection:'row', justifyContent:'space-between', 
                    pb:'10px', width:'100%', textAlign:'left'}}}>
  ...
  {new Date(invoice.date * 1000).toLocaleDateString()}
                    ...
                    <Stack sx={{'@media (max-width:770px)':{display:'flex', flexDirection:'row', justifyContent:'space-between', 
                    pb:'20px', width:'100%', textAlign:'left'}}}>
                      <Typography sx={{ fontSize: '12px', fontWeight: '600' }}>
                        Status
                      </Typography>
<Typography sx={{ fontSize: '12px' }}>
